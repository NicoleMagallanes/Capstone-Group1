...
<body class="antialiased bg-slate-300">
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-center bg-slate-300 selection:bg-red-500 selection:text-white">
        @if (Route::has('login'))
        ...
        <div class="relative sm:flex sm:justify-center p-10 sm:items-center min-h-screen bg-center bg-slate-300  selection:bg-red-500 selection:text-white">
    ...
    <div class="container my-24 mx-auto md:px-6 bg-slate-300">
