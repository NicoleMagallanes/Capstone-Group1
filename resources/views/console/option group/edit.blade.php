        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form id="record-data" method="post" action="{{ $article->id > 0 ? route('articles.update', $article->id) : route('articles.store') }}" class="mt-6 space-y-6" onsubmit="return validatePassword()">
                        @csrf
                        @if($article->id > 0)
                            @method('patch')
                        @endif
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea id="content" name="content" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full min-h-[200px]" required>{!! $article->content !!}</textarea>
